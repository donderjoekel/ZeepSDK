...
namespace ZeepSDK.External.Newtonsoft.Json.UnityConverters.Helpers
{
    internal static class TypeExtensions
    {
        public static IEnumerable<Type> GetLoadableTypes(this Assembly assembly)
        {
            ...
            {
#if DEBUG
                Console.WriteLine("ZeepSDK.External.Newtonsoft.Json.UnityConverters.Helpers.TypeExtensions: "
